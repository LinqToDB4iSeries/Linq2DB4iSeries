...
#pragma warning restore RS0030 // Do not use banned APIs
		...
		public bool StartsWith(char value) => str is not null && str.Length > 0 && str[0] == value;
	}
}
...
#pragma warning restore MA0028 // Optimize StringBuilder usage
	...
	public static StringBuilder AppendLine(
		...
		FormattableString formattableString)
	{
		return sb.AppendLine(formattableString.ToString(provider));
	}
...
public static class AdoAsyncDispose
{
