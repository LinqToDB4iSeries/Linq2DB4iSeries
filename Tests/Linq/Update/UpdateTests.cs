...
namespace Tests.xUpdate
{
	...
	public class UpdateTests : TestBase
	{
		...
		//[Test, DataContextSource(
		//	ProviderName.SqlCe, ProviderName.SQLite, ProviderName.DB2, "DB2.iSeries", ProviderName.Informix,
			...
			using (var db = GetDataContext(context))
			{
				...
				try
				{
					...
					var query = db.GetTable<Parent1>()
						.Where(p1 => p1.ParentID == id)
						.Select(p1 => new Parent1()
						{
					...
					var cnt = db.GetTable<Parent1>()
						.Where(p1 => p1.ParentID == id && query.Count() > 0)
						.Update(p1 => new Parent1()
						{
				...
				{
					db.GetTable<Parent1>().Delete(p1 => p1.ParentID == id);
				}
			}
		}

		//[Test, DataContextSource(ProviderName.DB2, "DB2.iSeries", ProviderName.Informix, ProviderName.Firebird, ProviderName.Sybase)]
