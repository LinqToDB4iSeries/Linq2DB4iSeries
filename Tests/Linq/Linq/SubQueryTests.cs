...
namespace Tests.Linq
{
	...
	public class SubQueryTests : TestBase
	{
		...
		//[Test, DataContextSource(
		//	ProviderName.SqlCe, ProviderName.Access, ProviderName.DB2, "DB2.iSeries", ProviderName.OracleNative, ProviderName.OracleManaged, ProviderName.MySql, ProviderName.Sybase)]
		...
		//[Test, DataContextSource(
		//	ProviderName.Access, ProviderName.DB2, "DB2.iSeries", ProviderName.OracleNative, ProviderName.OracleManaged, ProviderName.MySql,
		...
		//[Test, DataContextSource(
		//	ProviderName.SqlCe, ProviderName.DB2, "DB2.iSeries", ProviderName.OracleNative, ProviderName.OracleManaged, ProviderName.MySql, ProviderName.Sybase, ProviderName.Access)]
		...
		//[Test, DataContextSource(
		//	ProviderName.SqlCe, ProviderName.Access, ProviderName.DB2, "DB2.iSeries", ProviderName.OracleNative, ProviderName.OracleManaged, ProviderName.MySql, ProviderName.Sybase, ProviderName.SapHana)]
