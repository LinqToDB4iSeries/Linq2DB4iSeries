...
#error Unknown framework
			...
			UserProviders  = new HashSet<string>(testSettings.Providers ?? new string[] {}, StringComparer.OrdinalIgnoreCase);
			SkipCategories = new HashSet<string>(testSettings.Skip ?? new string[] {}, StringComparer.OrdinalIgnoreCase);
