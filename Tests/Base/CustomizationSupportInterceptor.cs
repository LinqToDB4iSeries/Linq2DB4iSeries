...
namespace Tests
{
	...
	{
		/// <summary>
		/// Intercept and mutate the set of supported providers
		/// </summary>
		/// <param name="providers">The globally supported providers from TestBase.</param>
		/// <returns></returns>
		public virtual IEnumerable<string> GetIdentityInsertMergeSupportedProviders(IEnumerable<string> providers)
			=> providers;

		/// <summary>
		/// Intercept and mutate the set of provider contexts from a DataSourcesBase attribute.
		/// </summary>
		/// <param name="contexts">The provider contexts.</param>
		/// <returns></returns>
		public virtual IEnumerable<string> GetInsertOrUpdateUnsupportedProviders(IEnumerable<string> providers)
			=> providers;

		/// <summary>
		/// Intercept and mutate the set of provider contexts for a specific test method. 
		/// </summary>
		/// <param name="contexts">The provider contexts.</param>
		/// <returns></returns>
		public virtual IEnumerable<string> GetMergeUnsupportedProviders(IEnumerable<string> providers)
			=> providers;
