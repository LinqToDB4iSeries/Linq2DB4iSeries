...
namespace LinqToDB.DataProvider.DB2iSeries
{
    ...
    public static class DB2iSeriesHISTypes
    {
        ...
        public static readonly HISConnectionTypeTypeCreator<string> DB2Clob = new HISConnectionTypeTypeCreator<string>();
        public static readonly TypeCreator<byte[]> DB2Binary = new TypeCreator<byte[]>();
        public static readonly HISConnectionTypeTypeCreator<byte[]> DB2Blob = new HISConnectionTypeTypeCreator<byte[]>();
    ...
    public class HISConnectionTypeTypeCreator<T> : TypeCreatorNoDefault<T>
    {
        ...
        public object CreateInstance(DataConnection value)
        {
            if (_creator == null)
            {
                _creator = GetCreator<IDbConnection>(DB2iSeriesHISTypes.ConnectionType);
            }
