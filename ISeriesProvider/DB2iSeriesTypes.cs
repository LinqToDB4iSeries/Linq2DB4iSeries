...
namespace LinqToDB.DataProvider.DB2iSeries
{
    ...
    public static class DB2iSeriesTypes
    {
        ...
        public static readonly DB2iTypeDescriptor<byte[]> Blob = new DB2iTypeDescriptor<byte[]>(DataType.Blob, "GetiDB2Blob", "iDB2Blob");
        ...
        public static readonly DB2iTypeDescriptor<string> Clob = new DB2iTypeDescriptor<string>(DataType.NText, "GetiDB2Clob", "iDB2Clob");
        ...
        public static readonly DB2iTypeDescriptor<string> DbClob = new DB2iTypeDescriptor<string>(DataType.NText, "GetiDB2DbClob", "iDB2DbClob");
    ...
    {
        public DB2iTypeDescriptor(Type dotnetType, DataType dataType, string datareaderGetMethodName, string datatypeName, bool canBeNull = true) 
            : base(dotnetType, dataType, datareaderGetMethodName, datatypeName, canBeNull)
        {
        }

        public DB2iTypeDescriptor(Type dotnetType, DataType dataType, string datareaderGetMethodName, string datatypeName, object nullValue, bool canBeNull = true) 
    ...
    public class DB2iTypeDescriptorDefault : DB2iTypeDescriptor
    {
        ...
        public DB2iTypeDescriptorDefault(Type dotnetType, DataType dataType, string datareaderGetMethodName, string datatypeName, bool canBeNull = true) 
            : base(dotnetType, dataType, datareaderGetMethodName, datatypeName, canBeNull)
        {
            creator = new Lazy<Func<object>>(() => TypeCreatorBuilder.BuildTypeCreator(Type));
        }

        public DB2iTypeDescriptorDefault(Type dotnetType, DataType dataType, string datareaderGetMethodName, string datatypeName, object nullValue, bool canBeNull = true) 
            : base(dotnetType, dataType, datareaderGetMethodName, datatypeName, nullValue, canBeNull)
        {
            creator = new Lazy<Func<object>>(() => TypeCreatorBuilder.BuildTypeCreator(Type));
        }
    ...
    public class DB2iTypeDescriptor<T1,T> : DB2iTypeDescriptor<T1>
    {
        ...
        public DB2iTypeDescriptor(DataType dataType, string datareaderGetMethodName, string datatypeName, bool canBeNull = true) 
            : base(dataType, datareaderGetMethodName, datatypeName, canBeNull)
        {
            creator = new Lazy<Func<T, object>>(() => TypeCreatorBuilder.BuildTypeCreator<T>(Type));
        }

        public DB2iTypeDescriptor(DataType dataType, string datareaderGetMethodName, string datatypeName, object nullValue, bool canBeNull = true) 
